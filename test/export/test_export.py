...
def forward(self, x):
    ...
    sym_constrain_range_default = torch.ops.aten.sym_constrain_range.default(item, min = 3, max = 5);  sym_constrain_range_default = None
    mul = -1 * item
    le = mul <= 0;  mul = None
    _assert_scalar_default = torch.ops.aten._assert_scalar.default(le, "Runtime assertion failed for expression -u1 <= 0 on node 'le'");  le = _assert_scalar_default = None
    mul_1 = -1 * item
    lt = mul_1 < -2;  mul_1 = None
    _assert_scalar_default_1 = torch.ops.aten._assert_scalar.default(lt, "Runtime assertion failed for expression -u1 < -2 on node 'lt'");  lt = _assert_scalar_default_1 = None
    lt_1 = item < 6
    _assert_scalar_default_2 = torch.ops.aten._assert_scalar.default(lt_1, "Runtime assertion failed for expression u1 < 6 on node 'lt_1'");  lt_1 = _assert_scalar_default_2 = None
...
def forward(self, x, y):
    ...
    sym_constrain_range_for_size = torch.ops.aten.sym_constrain_range_for_size.default(_local_scalar_dense);  sym_constrain_range_for_size_default = None
    sym_constrain_range = torch.ops.aten.sym_constrain_range.default(_local_scalar_dense, min = 3, max = 5);  sym_constrain_range = None
    mul = -1 * _local_scalar_dense
    le = mul <= 0;  mul = None
    _assert_scalar = torch.ops.aten._assert_scalar.default(le, "Runtime assertion failed for expression -u1 <= 0 on node 'le'");  le = _assert_scalar = None
    mul_1 = -1 * _local_scalar_dense
    lt = mul_1 < -2;  mul_1 = None
    _assert_scalar_1 = torch.ops.aten._assert_scalar.default(lt, "Runtime assertion failed for expression -u1 < -2 on node 'lt'");  lt = _assert_scalar_1 = None
    lt_1 = _local_scalar_dense < 6;  _local_scalar_dense = None
    _assert_scalar_2 = torch.ops.aten._assert_scalar.default(lt_1, "Runtime assertion failed for expression u1 < 6 on node 'lt_1'");  lt_1 = _assert_scalar_2 = None
